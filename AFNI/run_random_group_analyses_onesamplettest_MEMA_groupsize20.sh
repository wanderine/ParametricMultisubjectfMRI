...
ClusterDefiningThreshold1=2.5395
CDT1=2.3

ClusterDefiningThresholdP2=0.001
ClusterDefiningThreshold2=3.5794
CDT2=3.1	
...
do
	...
	do
		...
		echo "Current FWE 1 is $FWE1" > Results/results_AFNI_onesamplettest_${Study}_${Smoothing}_${DesignName}_MEMA_${CDT1}_groupsize20.txt
		echo "Number of failed group masks is $NoGroupMask" >> Results/results_AFNI_onesamplettest_${Study}_${Smoothing}_${DesignName}_MEMA_${CDT1}_groupsize20.txt
		echo "Number of failed group analyses is $NoGroupAnalysis" >> Results/results_AFNI_onesamplettest_${Study}_${Smoothing}_${DesignName}_MEMA_${CDT1}_groupsize20.txt

		echo "Current FWE 2 is $FWE2" > Results/results_AFNI_onesamplettest_${Study}_${Smoothing}_${DesignName}_MEMA_${CDT2}_groupsize20.txt
		echo "Number of failed group masks is $NoGroupMask" >> Results/results_AFNI_onesamplettest_${Study}_${Smoothing}_${DesignName}_MEMA_${CDT2}_groupsize20.txt
		echo "Number of failed group analyses is $NoGroupAnalysis" >> Results/results_AFNI_onesamplettest_${Study}_${Smoothing}_${DesignName}_MEMA_${CDT2}_groupsize20.txt

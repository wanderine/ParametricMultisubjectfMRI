...
do
	...
	touch SmoothnessEstimates/xsmoothnesses_onesamplettest_${Study}_${Smoothing}_${DesignName}_groupsize30.txt 
	touch SmoothnessEstimates/ysmoothnesses_onesamplettest_${Study}_${Smoothing}_${DesignName}_groupsize30.txt 
	touch SmoothnessEstimates/zsmoothnesses_onesamplettest_${Study}_${Smoothing}_${DesignName}_groupsize30.txt 
	...
	do
	    ...
	    if [ -e $ResultsDirectory/group_mask.nii  ]; then
			...
			if [ -e $ResultsDirectory/${Smoothing}_${Design}_${Comparison}+tlrc.HEAD  ]; then
				...
				echo "$XSmoothness" >> SmoothnessEstimates/xsmoothnesses_onesamplettest_${Study}_${Smoothing}_${DesignName}_groupsize30.txt 
				echo "$YSmoothness" >> SmoothnessEstimates/ysmoothnesses_onesamplettest_${Study}_${Smoothing}_${DesignName}_groupsize30.txt 
				echo "$ZSmoothness" >> SmoothnessEstimates/zsmoothnesses_onesamplettest_${Study}_${Smoothing}_${DesignName}_groupsize30.txt 
	...
	echo "Current FWE is $FWE" > Results/results_onesamplettest_${Study}_${Smoothing}_${DesignName}_OLS_${CDT}_groupsize30.txt
	echo "Number of failed group masks is $NoGroupMask" >> Results/results_onesamplettest_${Study}_${Smoothing}_${DesignName}_OLS_${CDT}_groupsize30.txt
	echo "Number of failed group analyses is $NoGroupAnalysis" >> Results/results_onesamplettest_${Study}_${Smoothing}_${DesignName}_OLS_${CDT}_groupsize30.txt

...
do
	...
	do
		...
		3dclust -dxyz=1 -1thresh $ClusterDefiningThreshold -1noneg  1.01 $ClusterThreshold  $ResultsDirectory/${Smoothing}_${Design}_${Comparison}+tlrc'[1]' 
	
		# Print clusters to text file
		3dclust -dxyz=1 -1thresh $ClusterDefiningThreshold -1noneg  1.01 $ClusterThreshold  $ResultsDirectory/${Smoothing}_${Design}_${Comparison}+tlrc'[1]' > clustersizes.txt
	...
	echo "Current FWE is $FWE" > results_${Study}_${Smooting}_${Design}_OLS.txt

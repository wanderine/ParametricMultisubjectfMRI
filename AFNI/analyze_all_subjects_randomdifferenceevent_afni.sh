...
do
	...
	for i in /home/andek/Data/fcon1000/${Study}/*; do 
	    ...
	    if [ -e ${i}/func/rest.nii.gz ]; then
    	    ...
    	    stim_dir=$top_dir/Research_projects/RandomGroupAnalyses/${Study}_randomevents
    	    ...
    	    afni_proc.py -subj_id $Subject                                   \
    	            ...
    	            -regress_stim_times $stim_dir/differenceEventsstim1_Subject${SubjectNumber}.txt $stim_dir/differenceEventsstim2_Subject${SubjectNumber}.txt    \
    	            -regress_stim_labels events1 events2                     \
    	            -regress_basis 'dmBLOCK'                                 \
    	            -regress_censor_motion 0.3                               \
    	            -regress_opts_3dD                                        \
    	                -jobs 8                                              \
    	                -gltsym 'SYM: events1 -events2' -glt_label 1 difference    \

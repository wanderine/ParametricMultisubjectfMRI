...
do
	...
	do	
		...
		do
			...
			echo "Current FWE is $FWE" > Results/results_AFNI_onesamplettest_fullmask_${Study}_${Smoothing}_${DesignName}_OLS_${CDT}_groupsize20_ACF.txt
			echo "Number of failed group masks is $NoGroupMask" >> Results/results_AFNI_onesamplettest_fullmask_${Study}_${Smoothing}_${DesignName}_OLS_${CDT}_groupsize20_ACF.txt
			echo "Number of failed group analyses is $NoGroupAnalysis" >> Results/results_AFNI_onesamplettest_fullmask_${Study}_${Smoothing}_${DesignName}_OLS_${CDT}_groupsize20_ACF.txt

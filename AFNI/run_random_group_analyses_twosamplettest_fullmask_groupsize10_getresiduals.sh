...
do
	...
	do
		...
		GroupDirectory=/home/andek/Research_projects/RandomGroupAnalyses/Results/AFNI/${Study}/${Smoothing}/${Design}
		ResultsDirectory=/home/andek/Research_projects/RandomGroupAnalyses/Results/AFNI/${Study}/${Smoothing}/${Design}/GroupAnalyses
		...
		do
		    ...
		    if [ -e $ResultsDirectory/group_mask.nii  ]; then
				...
				if [ -e $ResultsDirectory/${Smoothing}_${Design}_${Comparison}+tlrc.HEAD  ]; then
					...
					# Remove old results
					rm allbetasgroup1.nii
					rm allbetasgroup2.nii
					rm group1mean.nii
					rm group2mean.nii
					rm residualsgroup1.nii
					rm residualsgroup2.nii

					# First merge single subject beta scores into one file
					3dTcat -output allbetasgroup1.nii $GroupDirectory/${Subject1}.results/stats.${Subject1}+tlrc[1] \
                                                 	  $GroupDirectory/${Subject2}.results/stats.${Subject2}+tlrc[1] \
		                                              $GroupDirectory/${Subject3}.results/stats.${Subject3}+tlrc[1] \
                                                	  $GroupDirectory/${Subject4}.results/stats.${Subject4}+tlrc[1] \
                                                	  $GroupDirectory/${Subject5}.results/stats.${Subject5}+tlrc[1] \
                                                	  $GroupDirectory/${Subject6}.results/stats.${Subject6}+tlrc[1] \
                                                	  $GroupDirectory/${Subject7}.results/stats.${Subject7}+tlrc[1] \
                                                	  $GroupDirectory/${Subject8}.results/stats.${Subject8}+tlrc[1] \
                                                	  $GroupDirectory/${Subject9}.results/stats.${Subject9}+tlrc[1] \
                                                	  $GroupDirectory/${Subject10}.results/stats.${Subject10}+tlrc[1] 

					3dTcat -output allbetasgroup2.nii $GroupDirectory/${Subject11}.results/stats.${Subject11}+tlrc[1] \
                                                 	  $GroupDirectory/${Subject12}.results/stats.${Subject12}+tlrc[1] \
		                                              $GroupDirectory/${Subject13}.results/stats.${Subject13}+tlrc[1] \
                                                	  $GroupDirectory/${Subject14}.results/stats.${Subject14}+tlrc[1] \
                                                	  $GroupDirectory/${Subject15}.results/stats.${Subject15}+tlrc[1] \
                                                	  $GroupDirectory/${Subject16}.results/stats.${Subject16}+tlrc[1] \
                                                	  $GroupDirectory/${Subject17}.results/stats.${Subject17}+tlrc[1] \
                                                	  $GroupDirectory/${Subject18}.results/stats.${Subject18}+tlrc[1] \
                                                	  $GroupDirectory/${Subject19}.results/stats.${Subject19}+tlrc[1] \
                                                	  $GroupDirectory/${Subject20}.results/stats.${Subject20}+tlrc[1] 

					# Calculate mean of group 1
					3dMean -prefix group1mean.nii $GroupDirectory/${Subject1}.results/stats.${Subject1}+tlrc[1] \
												  $GroupDirectory/${Subject2}.results/stats.${Subject2}+tlrc[1] \
		                                          $GroupDirectory/${Subject3}.results/stats.${Subject3}+tlrc[1] \
                                                  $GroupDirectory/${Subject4}.results/stats.${Subject4}+tlrc[1] \
                                                  $GroupDirectory/${Subject5}.results/stats.${Subject5}+tlrc[1] \
					...
					# Calculate mean of group 2
					3dMean -prefix group2mean.nii $GroupDirectory/${Subject11}.results/stats.${Subject11}+tlrc[1] \
												  $GroupDirectory/${Subject12}.results/stats.${Subject12}+tlrc[1] \
		                                          $GroupDirectory/${Subject13}.results/stats.${Subject13}+tlrc[1] \
                                                  $GroupDirectory/${Subject14}.results/stats.${Subject14}+tlrc[1] \
                                                  $GroupDirectory/${Subject15}.results/stats.${Subject15}+tlrc[1] \
					...
					# Calculate residuals for group 1
					3dcalc -a allbetasgroup1.nii -b group1mean.nii -c $ResultsDirectory/group_mask.nii -expr 'c*(a - b)'  -prefix residualsgroup1.nii

					# Calculate residuals for group 2
					3dcalc -a allbetasgroup2.nii -b group2mean.nii -c $ResultsDirectory/group_mask.nii -expr 'c*(a - b)'  -prefix residualsgroup2.nii

					# Merge residuals
					3dTcat -output residuals.nii residualsgroup1.nii residualsgroup2.nii	

					mv residuals.nii /home/andek/Research_projects/RandomGroupAnalyses/Results/AFNI/AllGroupResidualsOLS/Beijing_${Smoothing}_${Design}_${Comparison}_residual.nii			

...
title('Average gradient magnitude for AFNI MEMA')
set(gca,'FontSize',15)
figure; image(average_gradient_magnitude_(:,:,slice)*0.015); colormap gray; axis image; axis off
title('Average smoothness for AFNI MEMA')
set(gca,'FontSize',15)
%print -dpng AFNIMEMA_smoothness.png
%print -deps AFNIMEMA_smoothness.eps

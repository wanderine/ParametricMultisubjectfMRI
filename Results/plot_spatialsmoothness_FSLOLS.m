...
for file = 1:files
    ...
    residuals = load_nii(['/home/andek/Research_projects/RandomGroupAnalyses/Results/FSL/AllGroupResidualsOLS/group_residuals_Beijing_6mm_Event2_comparison' num2str(file) '.nii.gz']);
    residuals = double(residuals.img);
...
figure
imagesc(mean_FWHMy(:,:,51) * voxel_size); colormap gray; colorbar; title('Smoothness in y direction')

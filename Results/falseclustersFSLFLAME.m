...
title('Average gradient magnitude for FSL FLAME')
set(gca,'FontSize',15)
figure; image(average_gradient_magnitude_(:,:,slice)*0.004); colormap gray; axis image; axis off
title('Average smoothness for FSL FLAME')
set(gca,'FontSize',15)
%print -dpng FSLFLAME_smoothness.png
%print -deps FSLFLAME_smoothness.eps

...
study = 'HCP';
load ../SPM/randomDifferenceEventsHCPAllSubjects.mat
...
for subject = 1:100
    ...
    subjectString = HCPSubjects{subject};
    
    fid = fopen(['/home/andek67/Research_projects/RandomGroupAnalyses/' study '_randomevents/differenceEventsstim1_' subjectString '.txt'],'w');    
    ...
    fid = fopen(['/home/andek67/Research_projects/RandomGroupAnalyses/' study '_randomevents/differenceEventsstim2_' subjectString '.txt'],'w');    
    for event = 1:numEvents

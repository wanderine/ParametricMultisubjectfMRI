...
do
	...
	do
		...
		echo "Starting random group comparison $Comparison !"
			...
			./RandomiseGroupLevel all_subjects.nii.gz -design design_matrix_twosamplettest_groupsize20.mat -contrasts contrasts_twosamplettest_groupsize20.con -mask MNI152_T1_2mm_brain_mask.nii.gz -permutations 1000 -quiet -inferencemode 0 -permutationfile permutations_twosamplettest_groupsize20.txt > log.txt
		...
		echo "Out of $Comparison random group comparisons, significant group differences were detected $SignificantDifferences times !" > /home/andek/Research_projects/RandomGroupAnalyses/Results/results_broccoli_twosamplettest_${Study}_${Design}_${Smoothing}_perm_voxel_groupsize20.txt

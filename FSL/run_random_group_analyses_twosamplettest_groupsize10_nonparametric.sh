        ...
        do
            ...
            do
                ...
                do
                    ...
                    RandomiseGroupLevel all_subjects.nii.gz -design design_matrix_twosamplettest_groupsize10.mat -contrasts contrasts_twosamplettest_groupsize10.con -mask MNI152_T1_2mm_brain_mask.nii.gz -permutations 1000 -quiet -cdt ${ClusterDefiningThreshold}

...
for d = 1:4
    ...
    for smoothing = 1:1
        ...
        for comparison = 1:1000
            ...
            disp(sprintf('Doing analysis %i ! \n',comparison))
            
            spm('Defaults','fMRI');
            spm_jobman('initcfg');
            clear jobs
            
            spm_file = ['D:\fcon1000\tempgroup\classical1\SPM.mat'];
            ...
            jobs{2}.stats{1}.factorial_design.dir = {'D:\fcon1000\tempgroup\classical1'};
            ...
            % Estimate
            jobs{2}.stats{2}.fmri_est.spmmat = {'D:\fcon1000\tempgroup\classical1\SPM.mat'};
            jobs{2}.stats{2}.fmri_est.method.classical = 1;
            
            % Setup contrast
            jobs{2}.stats{3}.con.spmmat = {'D:\fcon1000\tempgroup\classical1\SPM.mat'};
            ...
            try
                ...
                % Get t-map
                V = spm_vol('D:\fcon1000\tempgroup\classical1\spmT_0001.hdr');

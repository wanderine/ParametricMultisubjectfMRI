...
allRandomDurations1 = zeros(103,numEvents);
allRandomDurations2 = zeros(103,numEvents);

allRandomOnsets1 = zeros(103,numEvents);
allRandomOnsets2 = zeros(103,numEvents);
...
save('randomDifferenceEventsOuluAllSubjects.mat','allRandomOnsets1','allRandomOnsets2','allRandomDurations1','allRandomDurations2')
